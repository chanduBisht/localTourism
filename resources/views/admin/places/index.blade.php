                 ...
                 <!-- <h3 class="box-title">Hover Data Table</h3>-->
                  <form action="action/category1.php?subview=bulk_actions" method="post">
                    ...
                    <div class="col-md-2 col-xs-12 form-group pull-right">
                        <a href="{{route('admin.places.create')}}" class="btn btn-primary" title="Click for Add New course"><i class="fa fa-plus"></i> Add New </a>
                    </div>
    ...
    $(document).on('click', '#remove', function(){
        ...
        Swal.fire({
            ...
            if(result.value){
                ...
                var url = '{{ route('admin.places.destroy', ':id') }}';
