...
<html>
  <head>
    ...
    <link href="{{url('public/admin/dist/css/skins/_all-skins.min.css')}}" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="{{route('admin.dashboard')}}" class="logo"><b>Local Tourism</b></a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{url('public/admin/offer/logo_20160222155327.png')}}" class="user-image" alt="User Image"/>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="dashboard.php" class="btn btn-block btn-success">Dashboard</a>
                    </div>
                    <div class="pull-right">
                      <a href="{{route('admin.logout')}}" class="btn btn-block btn-success">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
