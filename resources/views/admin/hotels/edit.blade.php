                    ...
                    @method('PUT') <!-- Use PUT method override -->
                        <div class="box-body">
                            ...
                            <div class="form-group col-6 err_name">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Place Name" value="{{$hotel->name}}">
                            </div>
                            ...
                            <div class="form-group col-6 err_name">
                                ...
                                <textarea type="text" name="description" class="form-control" placeholder="Enter Description">{{$hotel->description}}</textarea>
                            </div>
                            <div class="form-group col-6 err_name">
                                <label>Hotel Facility</label>
                                <div id="facilityContainer">
                                    @foreach(explode(',',$hotel->facility) as $faci)
                                    <div class="input-group mb-2">
                                        <input type="text" name="facility[]" class="form-control" placeholder="Facility" value="{{$faci}}">
                            ...
                            <div class="form-group col-6 err_name">
                                ...
                                <input type="text" name="location" class="form-control" placeholder="Location" value="{{$hotel->location}}">
                            </div>

                            <div class="form-group col-6 err_name">
                                <label>Check In</label>
                                <input type="text" name="check_in" class="form-control" placeholder="Check In Time" value="{{$hotel->check_in}}">
                            </div>

                            <div class="form-group col-6 err_name">
                                <label>Check Out</label>
                                <input type="text" name="check_out" class="form-control" placeholder="Check Out Time" value="{{$hotel->check_out}}">
                            </div>
                        </div>
