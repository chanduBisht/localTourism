                 ...
                 <!-- <h3 class="box-title">Hover Data Table</h3>-->
                  <form action="action/category1.php?subview=bulk_actions" method="post">
                    ...
                    <div class="col-md-2 col-xs-12 form-group pull-right">
                        <a href="{{route('admin.traking.create')}}" class="btn btn-primary" title="Click for Add New course"><i class="fa fa-plus"></i> Add New </a>
                    </div>
                    ...
                    <div class="box-body ">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th>Traking Area</th>
                                <th>Traking Km</th>
                                <th>Traking Price (Per Person)</th>
                                <th>Traking Start Time</th>
                                <th>Traking Days</th>
                                <th>Traking Avaibility</th>
                                <th>Traking Description</th>
                                <th>Action</th>
                            </tr>
                            </thead>
                            <tbody>
...
<script type="text/javascript">
    $(function () {
        var table = $('.table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.traking.index') }}",
    ...
    $(document).on('click', '#remove', function(){
        ...
        Swal.fire({
            ...
            if(result.value){
                ...
                var url = '{{ route('admin.traking.destroy', ':id') }}';
